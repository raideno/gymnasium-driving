...
from src.environments.random import RandomPathObstacles, RandomSpawn, RandomRoadNetwork, RandomGoal
...
def make_environment(
    ...
    for wrapper_name in wrappers:
        if wrapper_name == "WithRoadInfo":
            ...
            env = gymnasium_driving.wrappers.observations.WithBaseInfo(env, with_position=base_with_position)
